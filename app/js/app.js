var ghostGame = angular.module('ghostApp', ['ui.router', 'ui.bootstrap', 'ngAnimate'])

.controller('AppCtrl', ['$scope', '$http', '$uibModal', '$window', function ($scope, $http, $uibModal, $window) {
